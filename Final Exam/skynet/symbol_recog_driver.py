...
# x 782  /
# x 783 /
init_pred, init_err, init_w, init_found = skyler.build_net(samp_vect, train_lbls[0], gens)
x0_axis = np.arange(0,gens,1).tolist()
y0_axis = init_err
skyler.ezplot((([x0_axis, y0_axis]), PLOC[0], f"img '5': dumbNet= {init_found} gens to find answer"), ax, plotType='plot')
